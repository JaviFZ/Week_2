...
let rainbow = ["rojo", "naranja", "amarillo", "verde", "azul", "violeta"];
let colors = ["blanco", "rojo", "negro"];
...
let myWorlds = ["Coche", "moto", "patin"];
export function add(myWorlds) {
    let coleccion = 0;
